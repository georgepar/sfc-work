...
function tacker_changes() {
    ...
    sed -i '494d' /usr/lib/python2.7/dist-packages/tacker/sfc/drivers/opendaylight.py
    sed -i '494 i\                    "nshc4": "flow",' /usr/lib/python2.7/dist-packages/tacker/sfc/drivers/opendaylight.py
    sed -i '495 i\                    "exts": "gpe"}' /usr/lib/python2.7/dist-packages/tacker/sfc/drivers/opendaylight.py
